...
static unsigned dim(quack::instance *&all) {
...
unsigned ui::bg(quack::instance *&all, float w, float h, dotz::vec4 cl) {
...
unsigned ui::menu_bg(quack::instance *&all, float w, float h, dotz::vec2 &p,
                     dotz::vec2 &s) {
